...
######
regional_specific_data <- FALSE # go to 02_geographies.Rmd and 03_remotesensing.Rmd scripts to process/make these files, as applicable; another option for this is to == "DaneCo"
...
} else if (regional_specific_data == "DaneCo") {
  bg_canopy <- read_csv()
  bg_ndvi <- read_csv()
  ctu_list_raw<- read_csv()
  nhood_list_raw<- read_csv()
